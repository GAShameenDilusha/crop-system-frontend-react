...
export  default function sideBarComponent({ isOpen }){
    return (
        <aside
            className={`bg-gradient-to-b from-black to-gray-950 text-white min-h-screen w-64 fixed top-0 left-0 border-r border-gray-200 drop-shadow-md transform transition-transform duration-300 z-50 ${
                isOpen ? "translate-x-0 top-20" : "-translate-x-64"
            } md:translate-x-0`}>
            <div className="p-1">
                <img
                    src="src/assets/images/Small%20GreenShadow-logo2.png"
                    alt="Green Shadow Logo"
                    className="w-2/4 mx-auto pb-2.5 drop-shadow-md"
                />
            </div>

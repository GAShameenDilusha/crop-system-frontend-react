...
export default function TopHeaderComponent({ toggleSidebar }: TopHeaderComponentProps) {
    ...
    return (
        <>
            <header
                ...
                <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-green-900 tracking-wide font-itim md:ml-0">{title}</h1>

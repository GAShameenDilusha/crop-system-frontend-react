import DashboardCardComponent from "../Compenents/DashboardCardComponent.tsx";

import WeatherMap from "../Compenents/WetherMap.tsx";
import TaskCalendar from "../Compenents/TaskShedularComponent.tsx";
...
export default function DashboardPage(){
    ...
    return (
        ...
        <>
            <section>
                <div className="flex flex-wrap items-center justify-center md:mt-40 md:ml-40 ml-0 mt-14 " >

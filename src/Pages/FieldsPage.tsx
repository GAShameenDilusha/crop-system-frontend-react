import SearchBarComponent from "../Compenents/SearchBarComponent.tsx";
import MainContainer from "../Compenents/MainContainer.tsx";
import AddBtnComponent from "../Compenents/AddBtnComponent.tsx";
import {useEffect, useState} from "react";
import AddFieldModal from "../Compenents/FieldModalComponent/AddFieldModal.tsx";
        ...
        <>
            ...
            {isViewModalOpen && selectedField && (
                ...
                <div
                    ...
                    <div
                        className="bg-gradient-to-b from-white to-green-700 rounded-lg shadow-2xl max-w-2xl w-full mx-4 sm:mx-8 my-8 relative"> {/* Modal Content */}
                        ...
                        <div className="p-6 border-t bg-gradient-to-b from-white to-green-700 flex justify-end space-x-3"> {/* Modal Footer */}
                            <button
                                type="button"
                                className="modal-btn"
                                onClick={closeViewModal}

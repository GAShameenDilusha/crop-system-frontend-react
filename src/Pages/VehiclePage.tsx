...
import AddVehicleModalComponent from "../Compenents/VehicleAddModalComponent/AddVehicleModal.tsx";
        ...
        <>
            ...
            {isViewModalOpen && selectedVehicle && (
                <div
                    ...
                    aria-hidden="true"
                >
                    <div className="bg-gradient-to-b from-white to-green-700 overflow-y-scroll rounded-lg shadow-2xl max-w-2xl w-full mx-4 sm:mx-8 my-8 relative max-h-[700px]">
                        {/* Modal Header */}
